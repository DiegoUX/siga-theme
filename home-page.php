					...
					<div class="container">
						<div class="row">
							<div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
								...
								<h4>Generamos y análizamos información del subtrópico de Argentina, para luego difundir la cartográfica. Ofrecemos capacitación técnica en distintos niveles educativos. Desarrollamos proyectos con incidencia sobre políticas ambientales y productivas.</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-3">
