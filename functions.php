...
function html5blank_styles()
{
    ...
    wp_register_style('linea-arrows', get_template_directory_uri() . '/fonts/font-icon.css', array(), '1.0', 'all');
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Sidebar Publicaciones', 'html5blank'),
...
function create_post_type_equipo()
{
    ...
    register_post_type('equipo', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Equipo', 'html5blank'), // Rename these to suit
            'singular_name' => __('Equipo Custom Post', 'html5blank'),
            'add_new' => __('Agregar Nuevo', 'html5blank'),
            'add_new_item' => __('Agregar Nuevo Miembro al Equipo', 'html5blank'),
            'edit' => __('Editar', 'html5blank'),
            'edit_item' => __('Edit Equipo Custom Post', 'html5blank'),
            'new_item' => __('New Equipo Custom Post', 'html5blank'),
            'view' => __('View Equipo Custom Post', 'html5blank'),
            'view_item' => __('View Equipo Custom Post', 'html5blank'),
